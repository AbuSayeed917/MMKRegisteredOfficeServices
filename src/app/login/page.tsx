    ...
    try {
      ...
      if (result?.error) {
        ...
        if (err.includes("ACCOUNT_LOCKED")) {
          ...
          setError(
            "Your account has been deactivated. Please contact support at info@mmkaccountants.co.uk for assistance."
          );
        } else if (err.includes("WRONG_PASSWORD")) {
        ...
        } else if (err.includes("MISSING_FIELDS")) {
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      ...
                      className="text-xs text-foreground underline transition-colors"
                    >
                      Forgot password?
                    </Link>
                  </div>
                ...
                <p className="text-center text-sm text-[var(--mmk-text-secondary)]">
                  ...
                  <Link href="/register" className="font-medium text-foreground underline transition-colors">
                    Register now
                  </Link>
                </p>
              </form>
